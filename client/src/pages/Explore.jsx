...
export function Explore() {
  ...
  const [viewType, setViewType] = useState("startups");
                ...
                <div className="p-6">
                  ...
                  <div className="pt-4 mt-4 border-t border-gray-200">
                    <div className="flex justify-between items-center">
                      ...
                      <button
                        onClick={() => handleBookSlot(item)}
                        className="flex items-center px-3 py-1 text-white bg-brand rounded-md transition-colors hover:bg-brand/90"
                      >
                        <Calendar size={16} className="mr-1" />
                        Book a Slot
                      </button>
